...
queries_df    = pd.read_csv("/home/gaurav/Downloads/Natural_Language_Queries_300.csv")  # your queries CSV
...
reranker      = CrossEncoder("../models/stage1_cross_encoder_finetuned_MiniLM_balanced_data_top5")
...
results_df.to_csv(
    '../results/12june_experiments/stage1_nl2glossary_balanceddata_rerankerfinetuned_top5_300_tough.csv',
    index=False
)
